...
export const zh: { [K in keyof typeof en]: string } = {
  ...
  "sidebar.clientCodex": "Codex",
  "sidebar.clientCursor": "Cursor",
  "sidebar.clientRunning": "执行中",
  ...
  "memory.tidyStream": "模型输出",
  "memory.tidyWaiting": "正在等模型响应…",
  "memory.tidyHeaderTimeout": "30 秒内没有收到模型的第一个字节，连接已放弃。",
  "memory.tidySummary": "删除 {deleted}，新增 {created}，合并 {merged}，更新 {patched}。",
  "memory.tidyActMerge": "合并 {name}",
  "memory.tidyActDelete": "删除 {name}",
  "memory.tidyActCreate": "新增 {name}",
  "memory.tidyActPatch": "更新 {name}",
  ...
  "settings.nav.clients": "客户端",
  "settings.clients.title": "本地 Agent",
  "settings.clients.desc": "只读本机 Claude、Codex、Cursor 的进度。这里不会发消息。",
  "settings.clients.enabled": "显示本地 Agent 任务",
  "settings.clients.enabledHint": "在侧边栏和已配对的手机上列出每个工具最近的任务。",
  "settings.clients.claudeDir": "Claude 目录",
  "settings.clients.codexDir": "Codex 目录",
  "settings.clients.cursorDir": "Cursor 目录",
