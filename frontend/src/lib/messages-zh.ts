...
export const zh: { [K in keyof typeof en]: string } = {
  ...
  "memory.skills": "技能",
  "memory.skillsHint":
    "重复流程会在回合结束后自动合并，手改之后也可以点这里立刻整理。",
  "memory.tidySkills": "整理重复技能",
  "memory.tidying": "正在合并重复技能…",
  "memory.tidyNone": "技能已经整理过了。",
  "memory.tidyDone": "已合并重复技能。",
  "memory.tidyScan": "正在扫描 {n} 个技能",
  "memory.tidyGroup": "正在查找重复组",
  "memory.tidyFold": "正在折叠重复组",
