...
export const en = {
  ...
  "header.switchToDeveloper": "Switch to developer view",
  "header.switchToUser": "Switch to user view",
  ...
  "sidebar.clientMissing": "Could not read this session.",
  ...
  "palette.transcriptMode": "Switch between user and developer view",
  ...
  "memory.skillsHint":
    "A finished turn folds same-subject names. Tidy asks the model to curate the whole catalog after a hand edit.",
  "memory.tidySkills": "Tidy skills",
  "memory.tidying": "Asking the model to curate skills…",
  "memory.tidyNone": "The model reviewed the catalog. Nothing to merge.",
  "memory.tidyEmpty": "No skills to curate.",
  "memory.tidyDone": "Skills curated.",
  "memory.tidyScan": "Scanning {n} skills",
  "memory.tidyReview": "Asking the model to review the catalog",
  "memory.tidyProgress": "Tidy progress",
  "memory.tidyStream": "Model output",
  "memory.tidyWaiting": "Waiting for the model…",
  "memory.tidyHeaderTimeout":
    "No first byte from the model within 30s. The connection was given up.",
  "memory.tidySummary":
    "Deleted {deleted}, created {created}, merged {merged}, updated {patched}.",
  "memory.tidyActMerge": "Merged {name}",
  "memory.tidyActDelete": "Deleted {name}",
  "memory.tidyActCreate": "Created {name}",
  "memory.tidyActPatch": "Updated {name}",
  "memory.tidyStatScanned": "{n} scanned",
  "memory.tidyStatMerged": "{n} merged",
  "memory.tidyStatDeleted": "{n} deleted",
  "memory.tidyStatCreated": "{n} created",
  "memory.tidyStatPatched": "{n} updated",
  "memory.tidyStatLeft": "{n} remaining",
  "memory.tidyMerged": "Merged",
  "memory.tidyDeleted": "Deleted",
  "memory.tidyCreated": "Created",
  "memory.tidyPatched": "Updated",
  "memory.tidyMergeLine": "{dropped} → {keep}",
  "memory.tidyDismiss": "Dismiss tidy result",
  "memory.noSkills":
  ...
  "transcript.workFoldTool": "1 tool",
  "transcript.workFoldTools": "{n} tools",
  "transcript.workFoldBoth": "Thought · {tools}",
  ...
  "schedule.createDrawerTitle": "New",
  "schedule.createClose": "Close",
  "schedule.createExpand": "Expand",
  "schedule.createCollapse": "Collapse",
  ...
  "schedule.titlePlaceholder": "Name",
  ...
  "schedule.promptPlaceholder": "What this wait should do",
  "schedule.details": "Details",
  "schedule.runsIn": "Runs in",
  "schedule.runsInNew": "New conversation each run",
  "schedule.runsInPinned": "Pinned",
  "schedule.frequency": "Frequency",
  "schedule.repeat": "Repeat",
  "schedule.repeatDelay": "After a delay",
  "schedule.repeatEvery": "On an interval",
  "schedule.repeatCron": "Cron",
  "schedule.cadence": "Cadence",
  "schedule.delay": "Delay (seconds)",
  "schedule.every": "Every (seconds)",
  "schedule.cron": "Cron",
  "schedule.cronPlaceholder": "minute hour day month weekday",
  ...
  "settings.nav.clients": "Clients",
  "settings.clients.title": "Local agents",
  "settings.clients.desc": "Read progress from Claude, Codex, and Cursor on this machine. Nothing here sends a message.",
  "settings.clients.enabled": "Show local agent tasks",
  "settings.clients.enabledHint": "Lists each tool's recent tasks in the sidebar and on a paired phone.",
  "settings.clients.claudeDir": "Claude directory",
  "settings.clients.codexDir": "Codex directory",
  "settings.clients.cursorDir": "Cursor directory",
  ...
  "settings.general.themeHint": "Match the system, or pin light or dark.",
  "settings.general.themeSystem": "Match the system",
  "settings.general.themeSystemCard": "System",
  ...
  "settings.general.fontSystem": "System default",
  "settings.general.fontSerif": "Serif",
  "settings.general.fontMono": "Mono",
  "settings.general.fontSameUI": "Same as UI font",
  "settings.general.uiFont": "UI font",
  "settings.general.uiFontHint": "Sidebar, Settings, title bar, composer chrome.",
  "settings.general.uiFontSize": "UI font size",
  "settings.general.contentFont": "Content font",
  "settings.general.contentFontHint":
    "Conversation body. Default follows UI so the sizes match.",
  "settings.general.contentFontSize": "Content font size",
  "settings.general.codeFont": "Code font",
  "settings.general.codeFontHint": "Fences and inline code in the transcript.",
  "settings.general.codeFontSize": "Code font size",
  ...
  "settings.general.fontSizeSameUI": "Same as UI",
  "settings.general.fontSizeSameContent": "Same as content",
  ...
  "settings.general.transcriptMode": "Transcript",
  "settings.general.transcriptModeHint":
    "User view folds thinking and tool calls into one live line. Developer view keeps every row.",
  "settings.general.transcriptUser": "User",
  "settings.general.transcriptDeveloper": "Developer",
  ...
  "settings.remote.displayName": "This computer's name",
  "settings.remote.displayNameHint":
    "What a bound phone shows on the host chip. Leave blank and this machine's hostname is used.",
  "settings.remote.threadLimit": "Threads on the phone",
  "settings.remote.threadLimitHint":
    "How many idle recents the phone lists below In progress before More. Live rows are a separate roster. Default 5.",
