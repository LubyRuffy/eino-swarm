...
export const en = {
  ...
  "memory.skillsHint":
    "Overlapping procedures fold after a turn, or tidy them here after a hand edit.",
  "memory.tidySkills": "Tidy overlapping skills",
  "memory.tidying": "Folding overlapping skills…",
  "memory.tidyNone": "Skills already tidy.",
  "memory.tidyDone": "Folded overlapping skills.",
  "memory.tidyScan": "Scanning {n} skills",
  "memory.tidyGroup": "Finding overlapping groups",
  "memory.tidyFold": "Collapsing overlapping groups",
