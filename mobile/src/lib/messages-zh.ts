...
export const zh: Record<MessageKey, string> = {
  ...
  "chat.emptyHint": "选好模型和思考强度再发送。这台手机会直接请求那个接口。",
  "chat.needModel": "先给这个接口指定模型，才能发送。",
  "chat.name": "名称",
  "chat.baseUrl": "接口地址",
  "chat.baseUrlPlaceholder": "https://your-endpoint/v1",
  "chat.apiKey": "API 密钥",
  "chat.apiKeyHint": "接口不需要密钥时留空。",
  "chat.api": "接口类型",
  "chat.apiChat": "Chat completions",
  "chat.apiResponses": "Responses",
  "chat.timeout": "超时（秒）",
  "chat.discover": "拉取模型",
  "chat.discovering": "正在拉取模型",
  "chat.discoverFailed": "没能列出模型。",
  "chat.defaultModel": "默认模型",
  "chat.typeModel": "输入模型名",
  "chat.save": "保存",
  "chat.remove": "移除",
  "chat.removeConfirm": "确认移除这个接口",
